...
(function () {
  ...
  const BP_GLOSSARY = {
    ...
    "Hierarchisches Modell":
      "Statistisches Modell mit mehreren Ebenen (z. B. Lernende in Klassen). Erlaubt partielles Pooling: Schätzungen pro Gruppe profitieren von der Information aller Gruppen.",
